import { isRefCountable, RefCntBase } from "../base/refCountBase";
import type {
    TMaterialInit,
    TParamSet,
    TParamView,
...
> extends RefCntBase {
    ...
    /** set once by the backend; called for every material that is destroyed */
    public static $onDestroy: ((mat: IMatHandle) => void) | null = null;
